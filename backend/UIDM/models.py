...
class ImageJsonModel(models.Model):
    ...
    metajson = models.FileField(max_length=255, upload_to=get_metajson_path, null=True)
    image = models.FileField(max_length=255, upload_to=get_image_path, null=True)
    
    detectedimage = models.FileField(max_length=255, upload_to=get_detectedimage_path, null=True)
    finaljson = models.FileField(max_length=255, upload_to=get_finaljson_path, null=True)
